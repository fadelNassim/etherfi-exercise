...
sealed class ModalResponse {
    ...
    data class Event(val topic: String, val name: String, val data: String, val chainId: String) :
        ModalResponse()
    ...
    data class SessionRequestResponse(
        ...
        val chainId: String?,
        val method: String,
        val result: Model.JsonRpcResponse
    ) : ModalResponse()

    data class SessionAuthenticateResult(
        val id: Long,
        val cacaos: List<Model.Cacao>,
        val session: Model.Session?
    ) : ModalResponse()

    data class SessionAuthenticateError(val id: Long, val code: Int, val message: String) :
        ModalResponse()

    data class ExpiredProposal(val pairingTopic: String, val proposerPublicKey: String) :
        ModalResponse()
    ...
    data object DisconnectSucces : ModalResponse()
